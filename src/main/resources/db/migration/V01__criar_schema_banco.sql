...
(
	...
	[NM_PERMISSAO] VARCHAR(200) NULL, UNIQUE ([NM_PERMISSAO]),
	[CD_SITUACAO] TINYINT NULL,
...
----------------------------------------------------------------------------------------
--ORDENACAO
CREATE TABLE [MED_ORDENACAO]
(
	[ID_ORDENACAO] [BIGINT] IDENTITY(1,1) NOT NULL, UNIQUE ([ID_ORDENACAO]),
	[ID_REGIONAL] [BIGINT] NOT NULL,
	[DT_ANO_MES_REF] [DATE] NOT NULL,
	[ID_GRUPO_FATURAMENTO] [BIGINT] NOT NULL,
...
----------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------
--DISTRIBUICAO LEITURA MOBILE (IGNORADO)
