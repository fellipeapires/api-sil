package br.com.sil.security.config;
...
import br.com.sil.security.token.CustomTokenEnhancer;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory().withClient("floripark")
				.secret("$2a$10$EuoZojx6IHva5UsKUwzqRurKl7eK5lnSlliFW5xMnvEFcUEO7Utba").scopes("read", "write")
