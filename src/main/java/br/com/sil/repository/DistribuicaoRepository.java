...
public interface DistribuicaoRepository extends JpaRepository<Distribuicao, Long>, DistribuicaoRepositoryQuery {
	...
	@Query(value = "INSERT INTO MED_DISTRIBUICAO_LEITURA_REGISTRO (ID_LEITURA, ID_REGIONAL, ID_USUARIO, FL_ASSOCIADO, DT_DISTRIBUICAO, CD_GRUPO_FATURAMENTO, DT_ANO_MES_REF) "
			...
			+ "LEFT OUTER JOIN MED_RETORNO_LEITURA AS C ON C.ID_LEITURA = A.ID_LEITURA AND C.ID_REGIONAL = ?1 AND C.ID_GRUPO_FATURAMENTO = B.ID_GRUPO_FATURAMENTO "
	...
	@Query(value="SELECT D.ID_USUARIO AS IDUSUARIO, A.ID_LEITURA AS IDLEITURA "
			...
			+ "LEFT OUTER JOIN MED_RETORNO_LEITURA AS E ON E.ID_LEITURA = D.ID_LEITURA AND E.ID_REGIONAL = ?1 "
	...
	@Query(value="DELETE MED_DISTRIBUICAO_LEITURA_REGISTRO "
			...
			+ "LEFT OUTER JOIN MED_RETORNO_LEITURA AS E ON E.ID_LEITURA = A.ID_LEITURA AND E.ID_REGIONAL = ?1 AND E.ID_GRUPO_FATURAMENTO = C.ID_GRUPO_FATURAMENTO "
	...
	@Query(value="SELECT "
			...
			+ "	LEFT OUTER JOIN MED_RETORNO_LEITURA AS E ON E.ID_LEITURA = A.ID_LEITURA AND E.FL_ATIVO = 1 AND E.ID_REGIONAL = ?1 AND E.ID_GRUPO_FATURAMENTO = B.ID_GRUPO_FATURAMENTO "
			+ "WHERE "
			+ "	B.ID_REGIONAL = ?1 "
