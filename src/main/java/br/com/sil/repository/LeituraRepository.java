...
public interface LeituraRepository extends JpaRepository<Leitura, Long>, LeituraRepositoryQuery {
	...
	@Modifying
	@Transactional
	@Query(value = "UPDATE MED_LEITURA SET CD_TAREFA_LEITURA = ?6, CD_TAREFA_ENTREGA = ?7 WHERE ID_LEITURA IN( "
			+ "SELECT B.ID_LEITURA "
	...
	@Modifying
	@Transactional
	@Query(value = "UPDATE MED_LEITURA SET CD_TAREFA_LEITURA = ?6 WHERE ID_LEITURA IN( "
			+ "SELECT B.ID_LEITURA "
			+ "FROM MED_IMPORTACAO A "
			+ "INNER JOIN MED_LEITURA B ON A.ID_IMPORTACAO=B.ID_IMPORTACAO "
			+ "INNER JOIN MED_GRUPO_FATURAMENTO AS D ON D.ID_GRUPO_FATURAMENTO = A.ID_GRUPO_FATURAMENTO "
	...
	@Modifying
	@Transactional
	@Query(value = "UPDATE MED_LEITURA SET CD_TAREFA_ENTREGA = ?6 WHERE ID_LEITURA IN( "
			+ "SELECT B.ID_LEITURA "
			+ "FROM MED_IMPORTACAO A "
			+ "INNER JOIN MED_LEITURA B ON A.ID_IMPORTACAO=B.ID_IMPORTACAO "
			+ "INNER JOIN MED_GRUPO_FATURAMENTO AS D ON D.ID_GRUPO_FATURAMENTO = A.ID_GRUPO_FATURAMENTO "
